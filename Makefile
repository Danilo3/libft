...
#    Updated: 2019/09/17 19:10:10 by ayellin          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC		:= ft_atoi.c ft_bzero.c ft_count_digits.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_islower.c ft_isprint.c ft_isspace.c ft_isupper.c ft_itoa.c ft_itostr.c \
...
test: $(NAME) $(TEST)
	$(CC) $(CFLAGS) $(TEST) -o test/test  -L. -lft
	./test/test
