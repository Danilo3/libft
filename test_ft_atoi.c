...
/*   Updated: 2019/09/20 13:41:40 by ayellin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char *test_crazy()
{
	int num;
	const char *str;

	str = "999999999999999999999999999999999999999999999999999999";
	num = ft_atoi(str);
	mu_assert_i("[ft] != [st]", num, atoi(str));
	return (0);
}

static char *test_long_long_max()
{
	int num;
	const char *str;
